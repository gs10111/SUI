...
//
// OCP: LimitOps e um par de predicados sobre a propria regra. Acrescentar uma operacao nova -
// por exemplo uma janela entre A e B - e escrever mais um LimitOps e apontar a regra para ele.
...
extern const LimitOps kOff;
extern const LimitOps kAtLeast;
extern const LimitOps kAtMost;
extern const LimitOps kModulus;
...
public:
    ...
    constexpr LimitRule(const LimitOps& operation, int16_t valueDeci,
